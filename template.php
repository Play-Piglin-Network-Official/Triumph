 ...
 *    License: MIT
 *
 *    Triumph Template - Made by Play Piglin Network
 *	  https://github.com/Play-Piglin-Network-Official/Triumph/
 *    License: GPL-3.0 license
 */

class PlayPiglinNetwork_Template extends TemplateBase {
    ...
    public function __construct($cache, $smarty, $language, $user, $pages) {
        $template = [
            'name' => 'Triumph',
            'version' => '1.0.0 - Nameless MC 2.0.0-pr13',
            'nl_version' => '2.0.0-pr13',
            'author' => '<a href="https://playpiglin.net/" target="_blank">Play Piglin Network</a>',
        ];
...
$template = new PlayPiglinNetwork_Template($cache, $smarty, $language, $user, $pages);
